...
import re
from constants import centene_wellcare_CCG
import boto3
import io
import pandas as pd
...
def extract_pdf_links(centene_wellcare_CCG):
    l1 = []
    for site in centene_wellcare_CCG:
...
def save_policy_files_to_s3(centene_wellcare_CCG):
    client_name = 'Centene'
    ...
    downloadable_links = extract_pdf_links(centene_wellcare_CCG)
